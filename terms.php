              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php
                    ...
                    $sql = "SELECT t.USER_ID, s.section_order, s.section_malay, sb.subsection_order, sb.subsection_malay, t.term_no, t.term_order, t.term_malay, t.term_english, t.date_created, t.ttoken FROM term t
