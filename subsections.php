          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Active Sub-Sections</h3>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="btn-group">
                                  ...
                                  <button type="button" data-href="pdeletesubsection.php?id=<?php echo $row['sbtoken']; ?>" class="btn btn-danger btnn-block btn-sm fas fa-trash-can" data-toggle="modal" data-target="#delete"></button>
                                  <?php } ?>
                              </div>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content bg-danger">
                                    <div class="modal-header">
                                      <h4 class="modal-title">Delete Sub-Section</h4>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                      </button>
                                    </div>
                                    <div class="modal-body">
                                      <p>Do you want to delete this sub-section?</p>
                                    </div>
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Deleted Sub-Sections</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT sb.date_deleted, sb.USER_ID, sb.subsection_no, s.section_order, s.section_malay, sb.subsection_order, sb.subsection_malay, sb.subsection_english, sb.date_created, sb.sbtoken FROM subsection sb JOIN section s ON s.section_no = sb.section_no WHERE s.date_deleted IS NOT NULL OR sb.date_deleted IS NOT NULL ORDER BY s.section_no, sb.subsection_order ASC";
                    $result = $conn->query($sql);
                    $counter = 1;
                    if($result-> num_rows > 0){
                        while ($row = $result-> fetch_assoc()){
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="btn-group">
                                  ...
                                  <button type="button" data-href="prestoresubsection.php?id=<?php echo $row['sbtoken']; ?>" class="btn btn-secondary btnn-block btn-sm fas fa-plus-square" data-toggle="modal" data-target="#restore"></button>
                                  <?php } ?>
                              </div>
                              <div class="modal fade" id="restore">
                                <div class="modal-dialog">
                                    <div class="modal-content bg-secondary">
                                        ...
                                        <div class="modal-body">
                                            <p>Do you want to restore this sub-section?</p>
                                        </div>
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="subadded">
  ...
  <div class="modal fade" id="subrestored">
    <div class="modal-dialog">
        <div class="modal-content bg-secondary">
            <div class="modal-header">
                <h4 class="modal-title">Success!</h4>
            ...
            <div class="modal-body">
                <p>Sub-Section has been successfully restored!</p>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
            </div>
